...
public protocol TransactionFeePrice: Hashable, Sendable, Equatable {
  var speed: TransactionFeeSpeed { get }
  var baseFee: Decimal { get }
  var tip: Decimal { get }
  ...
  init(baseFee: Decimal, tip: Decimal, speed: TransactionFeeSpeed)
  ...
  func amount(for limit: Decimal, decimals: Decimal?) -> Decimal
...
public struct EVMTransactionFeePrice: TransactionFeePrice, Hashable, Sendable {
  ...
  /// Zero (empty) transaction fee speed
  public static var zero: EVMTransactionFeePrice {
    return EVMTransactionFeePrice(baseFee: .zero, tip: .zero, speed: .zero)
  }
  ...
  ///   - exactTip: maxPriorityFeePerGas
  ///   - speed: TransactionFeeSpeed
  public init(exactBaseFee: Decimal, exactTip: Decimal, speed: TransactionFeeSpeed) {
    self.speed = speed
...
public struct SOLTransactionFeePrice: TransactionFeePrice, Hashable, Sendable {
  public let speed: TransactionFeeSpeed
  public let baseFee: Decimal
  public let tip: Decimal
  public var totalFee: Decimal {
  ...
  /// Zero (empty) transaction fee speed
  public static var zero: SOLTransactionFeePrice {
    return SOLTransactionFeePrice(baseFee: .zero, tip: .zero, speed: .zero)
  }
